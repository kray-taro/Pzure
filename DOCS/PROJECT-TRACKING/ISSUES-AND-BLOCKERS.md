...
| B-006 | Key management upgrade path | Security | Medium | 🔴 Open | Security Lead | MVP uses env-based AES key (ADR-003); plan envelope encryption / Key Vault for Phase 3. |
