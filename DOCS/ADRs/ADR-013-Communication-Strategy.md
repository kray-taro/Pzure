...
- Template approval lifecycle; incoming message intent routing; sensitive-content suppression.
- Required delivery-receipt fields: `provider_message_id`, `status`, `error_code`/`message`, `cost_estimate`, `sent_at`, `delivered_at`, `raw_response_json`.
