...
Test plan (each item is an automated, CI-runnable test; all must pass before Gate 0A sign-off and must stay green thereafter). Implementation is tracked in [#70](https://gitlab.com/cricketaustin-group/Pzure/-/issues/70):
